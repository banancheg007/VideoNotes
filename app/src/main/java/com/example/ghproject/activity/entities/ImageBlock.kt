...
//                val width = selectedImage.getWidth()
//                val height = selectedImage.getHeight()
//
//                val scaleWidth = dpToPx(100f, context) as Float / width
//                val scaleHeight = dpToPx(100f, context) as Float / height
